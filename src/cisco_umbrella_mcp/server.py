...
def create_mcp_server(settings: Settings) -> FastMCP:
    ...
    mcp = FastMCP(
        ...
        instructions=(
            ...
            "per-category request counts over a period "
            "(get_summaries_by_category, with get_categories to tell "
            "security categories from content ones), deployment inventory "
