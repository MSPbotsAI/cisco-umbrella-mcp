...
EXPECTED_TOOLS = {
    ...
    "cisco_umbrella_get_activity_dns": {"from_", "to"},
    "cisco_umbrella_get_activity_proxy": {"from_", "to"},
    "cisco_umbrella_get_activity_firewall": {"from_", "to"},
    "cisco_umbrella_get_activity_amp_retrospective": {"from_", "to"},
    "cisco_umbrella_list_roaming_computers": set(),
    "cisco_umbrella_list_applications": set(),
    "cisco_umbrella_list_protocols": set(),
    "cisco_umbrella_list_application_categories": set(),
